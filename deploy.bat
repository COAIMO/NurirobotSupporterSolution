...
docker build -f "C:\Users\cgdo\source\repos\NurirobotSupporterSolution\WebNURIROBOTSUPPORT\Dockerfile" --force-rm -t nurirobotsupportpublishweb  --label "com.microsoft.created-by=visual-studio" --label "com.microsoft.visual-studio.project-name=WebNURIROBOTSUPPORT" "C:\Users\cgdo\source\repos\NurirobotSupporterSolution"
